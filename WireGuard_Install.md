...
2. [Установка WireGuard](#-1-установка-wireguard)
3. [Создание папок и генерация ключей](#-2-создание-папок-и-генерация-ключей)
4. [Просмотр ключей](#-3-просмотр-ключей)
5. [Открытие порта](#-4-открытие-порта-опционально)
6. [Конфигурация сервера](#-5-конфигурация-сервера)
7. [Включение IP Forwarding](#-6-включение-ip-forwarding)
8. [Запуск VPN](#-7-запуск-vpn)
9. [Проверка](#-8-проверка)
...
## 🔓 4. Открытие порта (опционально)

> 💡 Этот шаг можно пропустить — если использовать **вторые правила маршрутизации** в конфиге (см. ниже), порт будет открываться и закрываться автоматически вместе с VPN.
